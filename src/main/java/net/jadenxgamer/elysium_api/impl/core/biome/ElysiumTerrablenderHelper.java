...
public class ElysiumTerrablenderHelper {
    ...
    public static void addEndSurfaceRule(SurfaceRules.RuleSource rules, String namespace) {
        SurfaceRuleManager.addSurfaceRules(SurfaceRuleManager.RuleCategory.END, namespace, rules);
    }
}
